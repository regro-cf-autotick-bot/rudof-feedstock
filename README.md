...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/rudof-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/rudof-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add pyrudof rudof
# for installing globally
pixi global install pyrudof rudof
```
...
It is possible to list all of the versions of `pyrudof` available on your platform:
...
```
pixi search pyrudof --channel conda-forge
```
